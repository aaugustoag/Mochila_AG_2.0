...
def importa_txt (arquivo):
    ...
    print('Qauntidade de Itens: ', len(itens))
    print('Capacidade da Mochila: ', mochila)

    return mochila, itens

# imprimindo geração
def imprime_geracao (populacao, g):
    print("Geração " + str(g) + " (" + str(len(populacao)) + "):" + str([item[0][1] for item in populacao]))
# fim
